...
if (1 == 0){
    ...
    # NOMS PAYS
    # data_map2003_nuts0_noms = geojsonio::geojson_read("./data/map1_60/NUTS_LB_2003_4326_LEVL_0.geojson", what = "sp")
    # data_map2006_nuts0_noms = geojsonio::geojson_read("./data/map1_60/NUTS_LB_2006_4326_LEVL_0.geojson", what = "sp")
    # data_map2010_nuts0_noms = geojsonio::geojson_read("./data/map1_60/NUTS_LB_2010_4326_LEVL_0.geojson", what = "sp")
    # data_map2013_nuts0_noms = geojsonio::geojson_read("./data/map1_60/NUTS_LB_2013_4326_LEVL_0.geojson", what = "sp")
    # data_map2016_nuts0_noms = geojsonio::geojson_read("./data/map1_60/NUTS_LB_2016_4326_LEVL_0.geojson", what = "sp")
}