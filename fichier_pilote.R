...
source("code_independant.R", encoding = "UTF-8", echo = T)

# puis on calcule le centre des régions ...
source("calcul_centre.R", encoding = "UTF-8", echo = T)

# et on ajoute les variables eurostat complémentaires
source("donnees_complementaires_carte.R", encoding = "UTF-8", echo = T)
