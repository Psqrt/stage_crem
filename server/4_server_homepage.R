...
L enquête EU-SILC (EU Statistics on Income and Living Condition) est une enquête d ampleur européenne à caractère longitudinale et multidimensionnelle. En effet, l enquête existe depuis 2003 et permet de suivre les unités sondées sur des périodes de 4 ans. Par ailleurs, le questionnaire vise plusieurs domaines d information :</p>
<ul>
<li><p style = "font-size: 17px; text-align: justify;">la structuration des ménages,</p></li>
<li><p style = "font-size: 17px; text-align: justify;">l unité de vie et les conditions de vie (logement, confort financier, ...),</p></li>
<li><p style = "font-size: 17px; text-align: justify;">les données individuelles (activité, ressources, bien-être, santé, ...).</p></li>
</ul>
<p style = "font-size: 17px; text-align: justify;">Les pays ayant rejoint le dispositif sont de plus en plus nombreux chaque année. En 2003, ce sont 7 pays, dont 6 membres de l Union Européenne qui ont été les premiers à enquêter leur population. En 2019, 35 pays sont concernés par l enquête EU-SILC, avec l intégration du Monténégro cette année.
</p>'))
})